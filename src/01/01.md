...
Following the development of webpages, CSS was developed to allow styling of web page elements.
...
- High IOPS (Input-Outputs)
- High Throughput (One Direction)
...
LB[Load Balancer]
S1[Server 1]
LB-->|Take the day off!|S1
```

---

We can replicate different parts of our architecture
